...
*)
#if !FA2_SOULBOUND_TOKEN
#define FA2_SOULBOUND_TOKEN

#include "../fa2/fa2/fa2_interface.mligo"
#include "../fa2/fa2/fa2_errors.mligo"
#include "../fa2/fa2/lib/fa2_operator_lib.mligo"
...
let transfer (_txs, _validate_op, _ops_storage, _ledger
    : (transfer list) * operator_validator * operator_storage * ledger) : ledger =
  failwith "TOKEN_IS_NOT_TRANSFERABLE"
