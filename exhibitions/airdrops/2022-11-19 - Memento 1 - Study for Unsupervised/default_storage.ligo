let default_storage: asset_storage = {
  exhibition_title = "Memento 1 - Study for Unsupervised";
  ...
  metadata = Big_map.literal [
    ("", 0x697066733a2f2f516d6356646d76766370777a77336d397833746645474c46746d4e6f637a4a587274327844586245477251567254);
  ];
  trustee = ({
